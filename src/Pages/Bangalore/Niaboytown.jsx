...
export default function Niaboy(){
      let [state,setState]=useState([])
      let [st,setst]=useState([])
      useEffect(()=>{
        fetch("https://content-qtripdynamic-qa-backend.azurewebsites.net//api/v1/adventures/detail?adventure=2447910730").then(x=>x.json()).then(x=>{setState(x)
