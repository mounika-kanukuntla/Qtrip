...
export default function Stonelum(){
      let [state,setState]=useState([])
      let [st,setst]=useState([])
      useEffect(()=>{
        fetch("https://content-qtripdynamic-qa-backend.azurewebsites.net//api/v1/adventures/detail?adventure=1921387712").then(x=>x.json()).then(x=>{setState(x)
