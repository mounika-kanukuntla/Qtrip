...
export default function Malaysia(){
    ...
    useEffect(()=>{
        fetch("https://content-qtripdynamic-qa-backend.azurewebsites.net//api/v1/adventures?city=malaysia").then(x=>x.json()).then(x=>setState(x)).catch(()=>console.log("Failed to fetch"))
    })
    return(
        <>
        <Part1/>
